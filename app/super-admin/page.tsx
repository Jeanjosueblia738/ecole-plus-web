...
const PLAN_LABELS: Record<string, string> = {
  TRIAL: 'Essai', STARTER: 'Starter', PRO: 'Pro', GROUP: 'Groupe', ENTERPRISE: 'Enterprise',
};
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <button onClick={() => toggleStatus(t.id, t.isActive)} disabled={actionLoading === t.id}
                            className={`p-1.5 rounded-lg transition-colors ${t.isActive ? 'text-red-400 hover:text-red-600 hover:bg-red-50' : 'text-green-500 hover:text-green-700 hover:bg-green-50'}`}
