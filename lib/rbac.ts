...
export const NAV_ACCESS: Record<string, Role[]> = {
  ...
  '/annees': ['ADMIN', 'FOUNDER'],
  '/annees/passage': ['ADMIN', 'FOUNDER', 'DIRECTOR', 'SECRETARY'],
...
export const can = {
  ...
  validateCahier: ['CENSOR', 'TEACHER', 'DIRECTOR'] as Role[],
